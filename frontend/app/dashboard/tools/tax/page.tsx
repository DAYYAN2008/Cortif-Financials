            ...
            <div className="space-y-10 relative z-10">
              <div>
                ...
                <div className={cn(
                  ...
                  isLoss ? "text-red-500 dark:text-red-400" : "text-emerald-500 dark:text-emerald-400"
                )}>
                  {isLoss ? "-" : "+"}{formatCurrency(Math.abs(netProfit), currency)}
                </div>
                {isLoss && (
                  <p className="text-sm text-red-500/80 dark:text-red-400/80 mt-2 font-medium">
              ...
              <div className="flex flex-col sm:flex-row gap-6 pt-4 border-t border-slate-200/60 dark:border-slate-800/60">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-2xl lg:text-3xl font-semibold tracking-tight text-slate-700 dark:text-slate-300">
                    {formatCurrency(taxOwed, currency)}
                  </div>
                </div>
              </div>
            </div>
