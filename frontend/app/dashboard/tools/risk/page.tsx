          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-2 border-t border-slate-200/50 dark:border-slate-700/50">
              ...
              <div className="flex-1 mt-2">
                ...
                <input
                  ...
                  placeholder="140"
                  className={cn(
                    "w-full rounded-xl border bg-white/50 px-4 py-3 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 transition-all dark:bg-slate-950/50 dark:text-white",
                    isInvalidStopLoss 
                      ? "border-red-400 focus:border-red-500 focus:ring-red-500/20 dark:border-red-500"
                      : "border-slate-200 focus:border-amber-500 focus:ring-amber-500/20 dark:border-slate-700/60 dark:focus:border-amber-400 dark:focus:ring-amber-400/20"
                  )}
                />
              </div>
            </div>
            {isInvalidStopLoss && (
              <p className="text-sm text-red-500 dark:text-red-400 mt-2">
                Stop-loss price must be lower than the entry price for long positions.
              </p>
            )}
          </div>
        </div>
          ...
          {isValid && !isInvalidStopLoss ? (
            <div className="space-y-10 relative z-10">
              ...
              <div className="pt-4 border-t border-slate-200/60 dark:border-slate-800/60">
                ...
                <div className="text-2xl lg:text-3xl font-semibold tracking-tight text-red-500 dark:text-red-400">
